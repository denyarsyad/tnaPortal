...
class Main_model extends CI_Model
{
  ...
  public function detail_incident($id)
  {
    ...
    (SELECT MAX(dd.NAMA_DEPT) FROM departemen dd WHERE dd.id_dept = I.target_dept) AS target_dept, problem, path_photo AS filefoto, status, (SELECT MAX(nama) FROM pegawai WHERE nik = i.id_action) AS id_action, date_action, reason_reject
    FROM INCIDENT I
